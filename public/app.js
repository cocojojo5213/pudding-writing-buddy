...
function bindStaticControls() {
  ...
  $('#add-character').addEventListener('click', () => guardAction(() => addItem('characters', blankCharacter())));
  $('#add-hook').addEventListener('click', () => guardAction(() => addItem('hooks', blankHook())));
  $('#add-outline').addEventListener('click', () => guardAction(() => addItem('outline', blankOutline())));
  $('#add-timeline').addEventListener('click', () => guardAction(() => addItem('timeline', blankTimeline())));
  $('#add-resource').addEventListener('click', () => guardAction(() => addItem('resources', blankResource())));
  $('#add-arc').addEventListener('click', () => guardAction(() => addItem('arcs', blankArc())));
  $('#add-chapter').addEventListener('click', () => guardAction(addChapter));
